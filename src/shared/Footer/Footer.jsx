...
const Footer = () => {
  ...
  <div>
    ...
    <p>Information</p>
    <p>Phone : 01860002876</p>
  </div> 
  <div>
    <span className="footer-title">Social</span> 
    <div className="grid grid-flow-col gap-4">
     <a target="blank" href="https://github.com/NahidNM"><BsGithub/></a>
     <a target="blank" href="https://www.facebook.com/mdnahid.hasan.77312"><BsFacebook/></a>
     <a target="blank" href="https://www.linkedin.com/in/md-nahid-hasan-94b084260/"><BsLinkedin/></a>
    </div>
  </div>
</footer>
      );
